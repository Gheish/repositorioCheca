...
/**
 * Description of PokemonControlador
 *
 * @author Aitor
 */
...
//    }
    ...
    function listaPokemon(){
        ...
        $totalPaginas = $pokemonDAO ->obtenerPaginadoFinal($pagina);
    ...
    function pokemonSeleccionado(){
        ...
        echo $pokemonDAO -> obtener($numPoke);
        
//        $fotodao = new FotoDAO($conn);
//        print_r($fotodao -> obtenerFotosResto($numPoke));
    ...
    function fotosSeleccionadas(){
        ...
        $fotodao = new FotoDAO($conn);
        echo $fotodao -> obtenerFotosResto($numPoke);
...
//    }
    ...
    function adivinaNombre(){
        ...
        $pokemonDAO = new PokemonDAO($conn);
        $numPoke = filter_var($_POST['ID'], FILTER_SANITIZE_NUMBER_INT);        
        echo $pokemonDAO -> adivinaNombre($numPoke);
        
    }
    
    function guardarAtributo(){
        
        $valorAtributo = $_POST['PokemonID'];

        // Almacenar el valor en la sesión
        $_SESSION['adivinado'] = $valorAtributo;
        array_push($_SESSION['listaAdivinados'], $valorAtributo);

        // Devolver una respuesta exitosa al cliente
//        echo $_SESSION['adivinado'];
        print_r($_SESSION['listaAdivinados']);
