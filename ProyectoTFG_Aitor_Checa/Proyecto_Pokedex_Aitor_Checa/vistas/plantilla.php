...
<html>
	...
	<style src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.7.0/css/all.min.css"></style>
        ...
        <link rel="stylesheet" media="(max-width: 1038px)" href="css/styleMedia.css">
        <style>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            if(window.innerWidth<1038){
                ...
                $(".foto").removeClass("col-lg-4").addClass("col-lg-12");
                $(".texto_pokemon").removeClass("col-lg-4").addClass("col-lg-12");
        ...
        window.addEventListener('load', function(){
            ...
            var indexPos = paginaActual.indexOf("index");
            var rutaPagina = paginaActual.substring(indexPos);

            if((rutaPagina === 'index.php?action=inicio') || (rutaPagina === 'index.php')){
            ...
            if((rutaPagina === 'index.php?action=inicio') || (rutaPagina === 'index.php')){
                ...
                $('#pokedex').on('click', 'index.php?action=listaPokemon');

            } else {

                $('#pokedex').on('click', 'index.php?action=inicio');
